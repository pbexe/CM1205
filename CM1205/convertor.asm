...
.code
	main proc
		...
		je calc_celcius ; Jump to the celcius calculation
		cmp al, 70 ; If it is F
		je calc_farenheit ; Jump to the farenheit calculation
		calc_celcius: ; Calculate the value in celcius
		call celcius ; Call celcius
		jmp str ; Jump to the next section of code
		calc_farenheit: ; Calculate the value in farenheit
		call farenheit ; Call farenheit
		str: ; This section converts the number into a string
